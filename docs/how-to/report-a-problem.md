...
- [How to upgrade the application](upgrade-the-application.md) — including how to go back
- [About mmm](../explanations/what-is-mmm.md) — why there is no telemetry to report for you
